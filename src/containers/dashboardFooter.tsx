...
export const DashboardFooter: React.FC = () => {
    return (
        <footer className="relative z-50 w-full bg-white rounded-lg shadow px-4 md:p-6 xl:p-8 dark:bg-gray-800 md:flex md:items-center md:justify-between">
            <div className="mb-4 xl:flex xl:items-center xl:space-x-3 md:mb-0">
                <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 xl:mb-0">
                    &copy; 2022 <a href="https://flowbite.com/" className="hover:underline" target="_blank">Flowbite</a>. All rights reserved.
                </p>
            ...
            <div className="flex justify-center items-center space-x-3">
                <button id="dropdownLanguageButton" data-dropdown-toggle="dropdownLanguage" className="flex p-1.5 items-center text-sm font-medium text-gray-900 rounded-full hover:text-primary-600 dark:hover:text-primary-500 md:mr-0 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-white" type="button">
                    <span className="sr-only">Open user menu</span>
                    <svg aria-hidden="true" className="h-3 w-4 ml-1.5 mr-2" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-us" viewBox="0 0 512 512">
                        <g fillRule="evenodd">
                            <g strokeWidth="1pt">
                ...
                {/* <!-- Dropdown menu --> */}
                <div id="dropdownLanguage" className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                ...
                <a href="#" data-tooltip-target="tooltip-settings" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-600">
                    <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 4a1 1 0 00-2 0v7.268a2 2 0 000 3.464V16a1 1 0 102 0v-1.268a2 2 0 000-3.464V4zM11 4a1 1 0 10-2 0v1.268a2 2 0 000 3.464V16a1 1 0 102 0V8.732a2 2 0 000-3.464V4zM16 3a1 1 0 011 1v7.268a2 2 0 010 3.464V16a1 1 0 11-2 0v-1.268a2 2 0 010-3.464V4a1 1 0 011-1z"></path></svg>
                ...
                <a href="#" data-tooltip-target="tooltip-options" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <div id="tooltip-options" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                    Options
                    <div className="tooltip-arrow" data-popper-arrow></div>
                </div>
            </div>
