...
export const SideMenu: React.FC<Props> = ({openState}) => {
    ...
    function changeModal() {
        setOpen({
            ...open,
            create: !open.create // true is an alternative, chose !open for reliability          
        });
        console.log("WELCOME STATE: " + open.welcome);
    }

    return (
        <aside className={`max-w-[200px] h-full border-gray-200 dark:border-gray-800 z-40 p-1 ${menuOpen.sideMenu ? "bg-white dark:bg-gray-800 w-96" : "bg-gray-800 w-28"} transition-width ease-in-out duration-300`} aria-label="Sidebar">
            <div className="overflow-y-auto py-4 px-3 h-full">
                <div className="w-full flex justify-end items-center">
                    <button onClick={() => handleMenuOpen("side-menu")} type="button" className="inline-flex items-center p-1 ml-1 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-800 dark:focus:ring-gray-800 hover:scale-105">
                    ...
                    <DelayRender loading={""} time={50}>
                        <div className="w-full px-5">
                            ...
                            <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                                <li>
                                    <button onClick={changeModal} className="w-full flex items-center justify-center p-2 text-base font-normal bg-blue-700 text-white rounded-lg hover:bg-blue-800 group">
                                        <span className="text-lg font-semibold tracking-wide">Create</span>
                                    </button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <button type="button" className="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-tasks" data-collapse-toggle="dropdown-tasks">
                                        ...
                                        <span className="flex-1 ml-3 text-left whitespace-nowrap">Gallery</span>
                                    ...
                                    <ul id="dropdown-tasks" className="hidden py-2 space-y-2">
                                        <li>
                                            <a href="#" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Uploads</a>
                                        </li>
                                        <li>
